...
import { MdDashboard, MdLibraryBooks, MdCategory, MdPeople, MdAssignment, MdLogout } from "react-icons/md";
...
export default function AdminSidebar() {
  ...
  const menuItems = [
    ...
    { path: "/admin/manage-course", label: "Manage Courses", icon: MdLibraryBooks },
    { path: "/admin/manage-category", label: "Manage Categories", icon: MdCategory },
    { path: "/admin/user", label: "Users", icon: MdPeople },
    { path: "/admin/user-report", label: "User Reports", icon: MdAssignment },
  ];
          ...
          <div className="flex items-center justify-between mb-10 mt-2">
            {!isCollapsed && (
              <div className="flex items-center space-x-2">
                <div className="w-10 h-10 bg-gradient-to-br from-blue-400/20 to-[#2C3E50] rounded-xl flex items-center justify-center shadow-lg">
